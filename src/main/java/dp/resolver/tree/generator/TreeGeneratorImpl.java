...
public class TreeGeneratorImpl implements TreeGenerator {
     ...
     */
    public TreeGeneratorImpl(String targetProjectPath, AnswerSetData answerSetData) {
        ...
        this.callTree = new CallTreeImpl();
    ...
    private void computeConflicts(ConflictType type) {
        ...
        for (CallNode node : this.callTree.getRootNodes()) {
    ...
    private void initModel(boolean isFromJar) {
        ...
        this.model.analyzeModel();
        this.callTree.addNodes(this.model.getCallNodes());
    }
    ...
    private boolean jarNotUsedOrNeeded(String jarPath) throws NullPointerException {
        ...
        boolean remove = true;
        for (Invocation invocation : this.callTree.getCurrLeaves()) {
            try {
